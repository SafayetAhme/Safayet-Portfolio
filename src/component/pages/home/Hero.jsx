...
const Hero = () => {
    return (
        <div id="hero">
            <div className="hero md:-mt-[90px] pt-16 md:pt-[180px] pb-[100px]" style={{ backgroundImage: 'url(https://i.ibb.co/2vSSHdW/Group-1000015945.png)' }}>
                <div className="justify-center container md:flex px-4 gap-16 md:px-10 items-start">
                    <div className="pr-[80px] md:pb-0 pb-12">
                        ...
                        <div className="flex pt-20 gap-4">
                                ...
                                <a href={resum} download>
                                    <button className="btn rounded-full border" type="">
                                        <strong className="font-rubik">
                                            <button className=" flex gap-2 items-center text-white font-rubik">Resume <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <button class="button w-64">asafayet21@gmail.com</button>
                            </a>
                        </div>
                    </div>
